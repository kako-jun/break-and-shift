...
export default function AncestorProbability() {
  ...
  const calculateAncestors = () => {
    ...
    for (let gen = 0; gen <= 40; gen++) {
      ...
      data.push({
        ...
        日本の人口,
        display: ancestors > 1000000000 ? `${(ancestors / 1000000000).toFixed(0)}兆` :
                 ancestors > 1000000 ? `${(ancestors / 1000000).toFixed(0)}億` :
  ...
  const 桓武天皇の世代 = 40;
  const 桓武天皇の先祖数 = Math.pow(2, 桓武天皇の世代);
  const 当時の日本の人口 = 3000000;
    ...
    <div className="space-y-12">
      ...
      <section className="space-y-6">
        ...
        <div className="simulator-container space-y-6">
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-boundary-dark p-4 rounded">
              <p className="text-sm text-boundary-mist mb-1">前世が有名人の確率</p>
          ...
          <div className="bg-red-900/20 p-4 rounded border-2 border-red-400">
            ...
            <ul className="space-y-2 text-boundary-mist text-sm">
              ...
              <li>
                • にもかかわらず、霊能力者が告げる前世は<strong>ほぼ100%有名人</strong>
              </li>
              <li>
          ...
          <div className="bg-boundary-dark p-4 rounded">
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-3">
              <div>
                <p className="text-sm text-boundary-mist mb-2">理想状態（確率通り）</p>
              ...
              <div>
                <p className="text-sm text-red-400 mb-2">現実（霊能力者の主張）</p>
                <ul className="text-xs text-boundary-mist space-y-1">
                  <li>• ほぼ100%の前世が有名人</li>
                  <li>• クレオパトラの前世が数千人</li>
                  <li>• 農民の前世は誰もいない</li>
      ...
      <section className="space-y-6">
        ...
        <div className="simulator-container space-y-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-boundary-dark p-4 rounded">
              <p className="text-sm text-boundary-mist mb-1">当時の日本の人口</p>
              <p className="text-2xl text-boundary-silver font-mono">
          ...
          <ResponsiveContainer width="100%" height={400}>
            ...
            >
              ...
              <YAxis
                ...
                tickFormatter={(value) => {
                  if (value >= 1000000000000) return `${(value / 1000000000000).toFixed(0)}兆`;
                  if (value >= 1000000000) return `${(value / 1000000000).toFixed(0)}億`;
              ...
              <Tooltip
                ...
                formatter={(value: any, name: string) => {
                  if (name === 'ancestors') {
                    if (value >= 1000000000000) return `${(value / 1000000000000).toFixed(0)}兆人`;
                    if (value >= 1000000000) return `${(value / 1000000000).toFixed(0)}億人`;
                    if (value >= 1000000) return `${(value / 1000000).toFixed(0)}百万人`;
          ...
          <div className="bg-green-900/20 p-4 rounded border-2 border-green-400">
            ...
            <ul className="space-y-2 text-boundary-mist text-sm">
              ...
              <li className="text-boundary-cyan">
                • 結論: 現代の日本人の<strong>ほぼ全員</strong>が桓武天皇の子孫である確率が極めて高い
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="simulator-container">
          <div className="space-y-4">
            ...
            <div className="bg-boundary-dark p-4 rounded">
              ...
              <p className="text-boundary-mist text-sm">
                理論上の先祖の数が、当時の人口を超えると、<strong>同じ人が何度も先祖に登場</strong>する。
                <br />
            ...
            <div className="bg-boundary-dark p-4 rounded">
              ...
              <p className="text-boundary-mist text-sm">
                数学的には、<strong>十分な世代を遡ると、ある時点の全員が共通の先祖になる</strong>。
                <br />
      ...
      <section className="space-y-4">
        ...
        <div className="simulator-container">
          <ul className="space-y-3 text-boundary-mist">
            ...
            <li className="bg-boundary-dark p-3 rounded">
              <strong className="text-boundary-cyan">遺伝子検査で〇〇民族</strong>
              <br />
              <span className="text-sm">
      ...
      <section className="space-y-4">
        ...
        <div className="simulator-container">
          ...
          <ul className="space-y-2 text-boundary-mist text-sm">
            <li>
              • 緑の線（理論上の先祖の数）は指数関数的に増加
            </li>
            <li>
              • 赤の線（当時の日本の人口）は緩やかに変化
            </li>
            <li>
              • 2つの線が交差する点を超えると、「パンペルスト現象」が発生
            </li>
            <li>
              • 40世代（桓武天皇の時代）では、先祖の数が人口の数十万倍
            </li>
            <li className="text-boundary-cyan">
